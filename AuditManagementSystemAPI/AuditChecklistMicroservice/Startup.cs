...
namespace AuditChecklistMicroservice
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(
                c => { c.SwaggerDoc("version1", new OpenApiInfo { Title = "AuditChecklistMicroservice",Version = "V1" }); }
                );
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/version1/swagger.json", "AuditChecklistMicroservice");
            });
