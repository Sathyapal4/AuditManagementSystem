...
namespace TestAuditEvaluationProvider
{
    public class TestsProvider
    {
        ...
        public void getEvaluation_ValidInput_ReturnOK()
        {
            ...
            AuditEvaluationProvider provider = new AuditEvaluationProvider(mock.Object);
            List<AuditEvaluationModel> result = provider.GetEvaluation();
